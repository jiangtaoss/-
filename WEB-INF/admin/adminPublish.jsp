...
<html>
  ...
  <body>
     ...
     <div class="mianfei_title">
	    	<img src="./images/mianfei.gif"/>
	  </div>
    <div class="mianfei_area">
    <form action="/taotao/publishServlet?type=admin" method="post">
	   <table>
	   	<tr>
	   	<td><font class="font-style3">请选择要发布的信息类别：</font></td>
	   	<td>
	   	<select name="info">
	   	<%	
	   		//得到类型信息，这个是上一个处理器准备好的
	   		ArrayList alInfoTypeList = (ArrayList)request.getAttribute("alInfoTypeList");
	   		InfoType infoType = new InfoType();
	   		for(int i=0; i<alInfoTypeList.size(); i++) {
	   			infoType = (InfoType)alInfoTypeList.get(i);
	   	 %>
	   	...
	   	<tr>
	   	<td><font class="font-style3">请输入标题:</font></td>
	   	<td><input type="text" id="title" name="title" /></td>
	   	</tr>
	   	<tr>
	   	<td><font class="font-style3">请输入内容:</font></td>
	   	<td><textarea cols="50" rows="7" id="content" name="content"></textarea></td>
	   	</tr>
	   	<tr>
	   	<td><font class="font-style3">联系人:</font></td>
	   	<td><input type="text" id="linkMan" name="linkMan" /></td>
	   	</tr>
	   	<tr>
	   	<td><font class="font-style3">联系电话:</font></td>
	   	<td><input type="text" id="tel" name="tel" /></td>
	   	</tr>
	   	<tr>
	   	<td></td><td><input type="image" src="./images/fa.jpg"/></td>
	   	</tr>
	   </table>
	   </form>
    </div>
